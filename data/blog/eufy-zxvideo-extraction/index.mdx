...
Unlike the video data (which is unencrypted), eufy encrypts all thumbnails with a proprietary scheme. Not worth trying to crack—just generate new thumbnails from the videos.
